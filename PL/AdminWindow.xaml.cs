...
namespace PL
{
    public partial class AdminWindow : Window
    {
        ...
        // תכונות תצוגה
        public int TotalExpiredCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.Expired).Count();
        public int TotalOpenCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.Open).Count();
        public int TotalOpenAtRiskCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.OpenAtRisk).Count();
        public int TotalInProgressCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.InProgress).Count();
        public int TotalClosedCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.Closed).Count();
        public int TotalInProgressAtRiskCalls => s_bl.Call.GetCallList(FilteredBy.Status, CallStatus.InProgressAtRisk).Count();
